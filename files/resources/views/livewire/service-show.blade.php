        ...
        <div class="space-y-8">
            ...
            <div class="space-y-6">
                <div class="flex items-end gap-4">
                    ...
                    @if ($service->discount)
                        <span class="text-xl text-gray-500 line-through">{{ number_format($service->original_price) }}
                            دولار</span>
                    @endif
                </div>

                <!-- مكون إضافة إلى السلة -->
            ...
            <div class="bg-white p-8  shadow-lg">
                ...
                <div class="space-y-4">
                    @foreach ($relatedServices as $service)
                        <a href="#"
                            class="group flex items-center gap-4 p-3 hover:bg-gray-50  transition-colors">
